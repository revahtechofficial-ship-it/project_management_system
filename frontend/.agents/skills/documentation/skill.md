...
## Description
Active reference for writing `dartdoc`-style documentation and comments. Load
this skill when documenting public (or private) APIs, deciding what and how to
document, or establishing a consistent commenting style.
