    ...
    routes: <RouteBase>[
      ...
      ShellRoute(
        ...
        routes: <RouteBase>[
          ...
          GoRoute(path: '/incidents', builder: (c, s) => const IncidentsPage()),
          GoRoute(path: '/git', builder: (c, s) => const GitPage()),
          ...
          GoRoute(path: '/resources', builder: (c, s) => const ResourcesPage()),
          ...
          GoRoute(path: '/invoices', builder: (c, s) => const InvoicesPage()),
