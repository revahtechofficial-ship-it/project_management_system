...
const List<_Feature> _features = <_Feature>[
  _Feature(
    ...
    AppColors.brand,
    'Four task views',
    'List, Board, Calendar and Gantt — same tasks, your choice.',
  ),
  _Feature(
    Icons.account_tree_rounded,
    AppColors.violet,
    'Dependencies & critical path',
    'Link tasks; successors auto-reschedule and the critical path is highlighted.',
  ),
  _Feature(
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  const SizedBox(height: 10),
                  Text(
                    'Create your account and start planning in seconds.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 16,
                      color: scheme.onSurfaceVariant,
